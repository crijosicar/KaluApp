export default {
  // Defaults
  default: 'Hmm, ocurrió un error inesperado',
  timeout: 'El servidor dejó de responder. Verifica tu conexión a internet',
  invalidJson: 'El valor retornado no es un objeto válido',
